...
function StatsSectionDesktop() {
  return (
    <div className="relative w-full" data-name="Stats section">
      <div className="flex flex-col items-center max-w-inherit w-full">
        <div className="box-border content-stretch flex flex-col gap-[30px] items-center max-w-inherit pb-[100px] pt-[67px] px-[15px] relative w-full overflow-hidden">
...
function NewBodyDesktop() {
  return (
    <div className="grid grid-cols-4 gap-x-[24px] gap-y-[32px] items-start max-w-[1200px] w-full relative" data-name="New body">
...
function NewContentDesktop() {
  return (
    <div className="flex flex-col gap-[100px] items-start relative w-full" data-name="New content">
      <p className="font-['Instrument_Sans:Regular',sans-serif] font-normal leading-none max-w-[633px] relative shrink-0 text-[64px] text-black tracking-[-3.2px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        Tech & Tools
      </p>
      <NewBodyDesktop />
...
function NewBodyTablet() {
  return (
    <div className="grid grid-cols-3 gap-x-[24px] gap-y-[32px] items-start max-w-[1200px] w-full relative" data-name="New body">
      {techTools.map((tool, index) => (
        <TechToolIcon key={index} name={tool.name} icon={tool.icon} />
      ))}
    </div>
...
function NewSectionTablet() {
  return (
    <div className="relative w-full" data-name="Tech & Tools">
      <div className="flex flex-col items-center max-w-inherit w-full">
        <div className="box-border flex flex-col gap-[30px] items-center max-w-inherit pb-[150px] pt-[67px] px-[15px] relative w-full">
          <div className="h-0 relative shrink-0 w-full" data-name="Divider">
            <div className="absolute bottom-[-0.5px] left-0 right-0 top-[-0.5px]">
...
function NewBodyMobile() {
  return (
    <div className="grid grid-cols-2 gap-x-[16px] gap-y-[24px] items-start max-w-[1200px] w-full relative" data-name="New body">
      {techTools.map((tool, index) => (
...
function NewContentMobile() {
  return (
    <div className="relative w-full" data-name="New content">
      <div className="w-full">
        <div className="box-border flex flex-col gap-[16px] items-start px-[16px] py-0 relative w-full">
          <p className="font-['Instrument_Sans:Regular',sans-serif] font-normal leading-none max-w-[633px] relative shrink-0 text-[64px] text-black tracking-[-3.2px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
            Tech & Tools
          </p>
          <NewBodyMobile />
...
function StatsNumbersDesktop() {
  return (
    <div className="relative w-full" data-name="Stats content">
      <div className="w-full">
        <div className="box-border content-stretch flex gap-[20px] items-start px-[15px] py-[32px] relative w-full">
          <StatContentDesktop />
          <Stat2Desktop />
          <Stat3Desktop />
        </div>
...
function StatsNumbersMobile() {
  return (
    <div className="relative w-full" data-name="Stats content">
      <div className="w-full">
        <div className="box-border content-stretch flex flex-col gap-[20px] items-start pb-[16px] pt-[32px] px-[15px] relative w-full">
          <StatContentMobile />
          <Stat2Mobile />
          <Stat3Mobile />
        </div>
...
function StatsNumbersSectionDesktop() {
  return (
    <div className="relative w-full" data-name="Stats Numbers section">
      <div className="flex flex-col items-center max-w-inherit w-full">
        <div className="box-border content-stretch flex flex-col gap-[30px] items-center max-w-inherit pb-[100px] pt-[67px] px-[15px] relative w-full overflow-hidden">
          <div className="h-0 relative shrink-0 w-full" data-name="Divider">
            <div className="absolute bottom-[-0.5px] left-0 right-0 top-[-0.5px]">
...
function StatsNumbersSectionTablet() {
  return (
    <div className="relative w-full" data-name="Stats Numbers section">
      <div className="flex flex-col items-center max-w-inherit w-full">
        <div className="box-border content-stretch flex flex-col gap-[30px] items-center max-w-inherit pb-[100px] pt-[67px] px-[15px] relative w-full overflow-hidden">
...
function StatsNumbersSectionMobile() {
  return (
    <div className="relative w-full" data-name="Stats Numbers section">
      <div className="flex flex-col items-center max-w-inherit w-full">
        <div className="box-border content-stretch flex flex-col gap-[30px] items-center max-w-inherit pb-[100px] pt-[67px] px-[15px] relative w-full overflow-hidden">
...
function StatsNumbersSection() {
  const { width } = useActiveBreakpoint();
  if (width < 800) {
    return <StatsNumbersSectionMobile />;
  }
  if (width < 1280) {
    return <StatsNumbersSectionTablet />;
  }
  return <StatsNumbersSectionDesktop />;
}

// StatsNumbersSection은 전역으로 사용 가능
...
function AwardsSectionDesktop() {
  return (
    <div className="relative w-full" data-name="Awards section">
      <div className="max-w-inherit w-full">
        <div className="box-border content-stretch flex flex-col gap-[30px] items-start max-w-inherit pb-[100px] pt-0 px-[15px] relative w-full overflow-hidden">
          <div className="h-0 relative shrink-0 w-full" data-name="Divider">
            <div className="absolute bottom-[-0.5px] left-0 right-0 top-[-0.5px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1250 1">
                <path d="M0 0.5H1250" id="Divider" stroke="var(--stroke-0, black)" />
...
function AwardsSectionMobile() {
  return (
    <div className="relative w-full" data-name="Awards section">
      <div className="w-full">
        <div className="box-border content-stretch flex flex-col gap-[30px] items-start pb-[100px] pt-0 px-[15px] relative w-full overflow-hidden">
          <div className="h-0 relative shrink-0 w-full" data-name="Divider">
            <div className="absolute bottom-[-0.5px] left-0 right-0 top-[-0.5px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 345 1">
                <path d="M0 0.5H345" id="Divider" stroke="var(--stroke-0, black)" />
